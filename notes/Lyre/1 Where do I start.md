...
Well, If I am going to instruct the computer to stream music, I need to know how to make it do anything at all. In JS, to describe the computer its' function, we use _functions_. Below is an example of a function that adds two numbers:
