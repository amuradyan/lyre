...
As its' [predecessor](https://github.com/amuradyan/shvi), it will be written in JS, but with _streaming at its core_ this time, so it can _run in the browser_. While taking this notes, I'll do that from the standpoint of someone who knows nothing of the Javascript language and accompany the notes with exploratory JS exercises.
